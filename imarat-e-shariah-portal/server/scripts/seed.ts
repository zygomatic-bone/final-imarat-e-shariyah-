...
import {
  ...
  siteSettingsTable, usersTable, galleryImagesTable,
} from "../src/db";
...
async function seed() {
  ...
  /* ── Admin User ── */
  const adminEmail = process.env.ADMIN_EMAIL ?? "admin@imarateshariah.in";
  ...
  await db.insert(galleryImagesTable).values([
    { url: "", caption: "Annual Conference 2024", category: "events", sortOrder: 1 },
    { url: "", caption: "Darul Qaza Proceedings", category: "judicial", sortOrder: 2 },
    { url: "", caption: "Shura Session", category: "events", sortOrder: 3 },
    { url: "", caption: "Community Outreach", category: "community", sortOrder: 4 },
    { url: "", caption: "Educational Program", category: "education", sortOrder: 5 },
    { url: "", caption: "Mangaluru Inauguration", category: "events", sortOrder: 6 },
    { url: "", caption: "Media & Press", category: "media", sortOrder: 7 },
    { url: "", caption: "Special Event 2025", category: "events", sortOrder: 8 },
  ]).onConflictDoNothing();
